...
def main():
    ...
    # Save JSON
    out_json = os.path.join(OUTPUT_DIR, 'alpha_scores.json')
    ...
    print(f"💾 Saved: {os.path.join(OUTPUT_DIR, 'alpha_report.html')}")
...
<script>
  ...
  async function scoreStock() {{
    ...
    out = os.path.join(OUTPUT_DIR, 'alpha_report.html')
