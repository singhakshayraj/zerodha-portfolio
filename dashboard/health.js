  ...
  function buildSuite() {
    ...
    return [
      ...
      },
      {
        ...
        validate: r => kiteSkipIf(r) || r.raw?.data?.equity !== undefined || r.raw?.equity !== undefined,
      ...
      },
      {
        ...
        validate: r => kiteSkipIf(r) || r.raw?.data?.net !== undefined || r.raw?.net !== undefined || Array.isArray(r.raw?.data),
